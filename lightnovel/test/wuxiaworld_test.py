...
""".replace('\n', ''),
    ...
    def test_conflation_chapter_1_2(self):
        ...
        self.assertIsNotNone(chapter1)
        self.assertTrue(isinstance(chapter1, WuxiaWorldChapter))
        self.assertFalse(chapter1.success)
        self.assertTrue(chapter1.parse())
        self.assertTrue(chapter1.success)
        self.assertEqual(1, chapter1.get_number())
        self.assertEqual(1, chapter1.get_subnumber())
        self.assertEqual('Big Sis, I’m afraid this is a misunderstanding!', chapter1.get_title())
        ...
        self.assertTrue(isinstance(chapter2, WuxiaWorldChapter))
        self.assertFalse(chapter2.success)
        self.assertTrue(chapter2.parse())
        self.assertTrue(chapter2.success)
        self.assertEqual(1, chapter2.get_number())
        self.assertEqual(2, chapter2.get_subnumber())
        self.assertEqual('Big Sis, I’m afraid this is a misunderstanding!', chapter2.get_title())

        self.assertTrue(chapter1.is_conflatable_with(chapter2))
        chapter1.conflate_with(chapter2)
